<script>
  ...
  async function onClickGenerate() {
    ...
    result = await newMapCodex(params, {maptoolUrl, svg:true, codexPassword: password, codexGeneratePassword: false});
...
<div>
  ...
  <CreateMap {mapImg} {onClickGenerate} bind:mapParams={mapParams}></CreateMap>
</div>
